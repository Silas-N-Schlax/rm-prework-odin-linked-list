...
```bash
git clone https://github.com/Silas-N-Schlax/rm-prework-odin-linked-list.git
```
...
* Refactoring old code I hadn't looked in over a year.
* Taking loops and turning them into recursive methods
